...
TERMINATE_ALL_CUSTOM_SCRIPTS_WITH_THIS_NAME(Script* script)
{
        ...
        bool terminate_self = !std::strncmp(script->name_, game::ScriptParams[0].szVar, Script::KEY_LENGTH_IN_SCRIPT) ? true : false;

        while (script_mgr::terminate_script(game::ScriptParams[0].szVar));
